    ...
    <div className="container">
      ...
      >
        ...
        <Modal
          ...
          contentLabel="주문 확인"
        >
          <h2 style={{fontSize: 20, textAlign: "center"}}>발주 완료로<br />상태를 변경하시겠습니까?</h2>
          <h2 style={{fontSize: 12,color: "#587302",marginBottom: "4px"}}>모든 배송준비가 완료되면 눌러주세요.</h2>
          <button className="basic_btn modalBtn" style={{marginTop:"4px"}} onClick={handleConfirmOrder}>발주 확인하기</button>
